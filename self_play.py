...
def self_play(
    ...
    for i in range(start_index, repeat_count):
        ...
        history_data.extend(first_brain.history[:])
        history_data.extend(second_brain.history[:])
...
def self_play_dualmodel(
    ...
    for i in range(repeat_count):
        ...
        first_brain.update_history(value)
        second_brain.update_history(-value)
        first_history_data.extend(first_brain.history)
        second_history_data.extend(second_brain.history)
